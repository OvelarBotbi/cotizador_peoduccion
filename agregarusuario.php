		...
		<div class="card-body">
		  <form id="myP1" action="validar.php" method="post" enctype="multipart/form-data">
		   <div>
              <div class="row">
                  <div class="col-2" > 
                      <button style="float:left;" type="button" class="btn btn-warning"  ng-click="regusu()"><li class=" fas fa-reply"></li></button>
                  </div>
              </div>
				...
				<div class="row">
					<div class="col-6">
						<div>USUARIO</div>
						<div><input type="text" id="usuario" name="nickusu" style="text-transform:uppercase;"  onkeyup="comprobarUsuario()" onkeyup="javascript:this.value=this.value.toUpperCase();" value='<?php   if(isset($_POST['editusua'])){echo $usuario;} ?>' placeholder="USUARIO" class="form-control" required></div>
