  ...
  <div style="height: 85%; width: 100%; background-color: #00528A;">
    ...
    <div style="height: 40%; width: 100%; display: inline-block; position: relative;">
      ...
      <div
        ...
        <h3 style="text-align: left; font-size: 26px; color: #00AEEF; margin: 10;"><?php echo "COTIZACION ".$mainTitle; ?></h3>
        <h2 style="text-align: left; font-size: 22px; color: #F7931D; margin: 0 10 10 10;"><?php echo $secondTitle; ?>
        </h2>
...
<?php
  ...
  while($var=mysqli_fetch_row($result)){
    ...
    $idcomponente=$var[1];
    $hijos=$conn->query("SELECT * FROM cotizacion_detallada WHERE id_component=$idcomponente");
    ...
    while($imgggg = $iiigggmmm->fetch_array(MYSQLI_ASSOC)) {
      ...
      if($regg>0){
        print '
          <tr>
         <td colspan="4" class="td-nombre"><img src="../../'.$dirrr.'"  align="center" style="width:400px; height: 300; margin-right: auto;  margin-left: auto; " class="center"  ></td>
         </tr>';
            }
         print " 
  ...
  while($var=mysqli_fetch_row($result)){
    ...
    while($imggggop = $iiigggmmmop->fetch_array(MYSQLI_ASSOC)) {
      ...
      if($reggop>0){
        print '
          <tr>
         <td colspan="4" class="td-nombre"><img src="../../'.$dirrrop.'"  style="width:250px; height: 250px; " class="center" ></td>
         </tr>';
            }
         print " 
