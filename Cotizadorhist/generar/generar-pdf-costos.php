...
$result = $conn->query("SELECT * FROM histrotatorio as rota LEFT JOIN imagenes as img ON img.id_comp=rota.plataforma WHERE rota.numcotizacion='$numcotizacion'");
      ...
      print "
        ...
        <thead>
          ...
          <tr>
            ...
            <th class='td-subtitle'>COSTO/UNI</th>
            <th class='td-subtitle'>TOTAL</th>
          </tr>
        </thead>
        <tbody>
        ";
      $resul = $conn->query("SELECT * FROM hist_cotizacion_detallada WHERE id_component='$idcomponente' and numcotizacion='$numcotizacion' and ischeck=1 ORDER BY orden ");
...
print "<page backtop='-3mm' backbottom='-19mm' backleft='-3mm' backright='-3mm'>
 ...
 <polygon id='left-polygon'  points='0 170,269 170,327 0,0 0'>
...
try {
  ...
  $html2pdf->Output('CotCostos ' . $nomcliente . Date("d-m-Y", time()) . '.pdf');
