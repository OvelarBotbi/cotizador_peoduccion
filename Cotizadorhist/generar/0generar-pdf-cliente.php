  ...
  while($var=mysqli_fetch_row($result)){
    ...
    while($imgggg = $iiigggmmm->fetch_array(MYSQLI_ASSOC)) {
      ...
      if($regg>0){
        print '
          <tr>
         <td colspan="3" class="td-nombre"><img src="../../'.$dirrr.'"  style="width:250px; height: 250px; " ></td>
         </tr>';
            }
         print " 
  ...
  while($var=mysqli_fetch_row($result)){
    ...
    while($imggggop = $iiigggmmmop->fetch_array(MYSQLI_ASSOC)) {
      ...
      if($reggop>0){
        print '
          <tr>
         <td colspan="3" class="td-nombre"><img src="../../'.$dirrrop.'"  style="width:250px; height: 250px; " ></td>
         </tr>';
            }
         print " 
