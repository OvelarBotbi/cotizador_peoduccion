...
<?php
 ...
 $totalcostos=0;
  ...
  //$reg= $result->num_rows;
?>
<page backtop="4.000mm" backbottom="0.000mm" backleft="0.000mm" backright="0.000mm">
<div class='container'>
<?php
    ...
    $idcomponente=$var[1];
        ...
        <tbody>
        ";
        $resul=$conn->query("SELECT * FROM cotizacion_detallada WHERE id_component='$idcomponente' and id_usuario='$idUsuario' and idsession='$idSesion' and ischeck=1 ORDER BY orden ");
 ...
 $result=$conn->query("SELECT * FROM cotizacion_detallada WHERE id_usuario='$idUsuario' and idsession='$idSesion' and id_component=id_producto and ischeck=1 ORDER BY orden ");
  //$reg= $result->num_rows;
  while($var=mysqli_fetch_row($result)){
    $nombreComp = utf8_encode($var[2]);
    $idcomponente=$var[1];
